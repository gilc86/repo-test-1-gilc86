...
import { HelloDebugProps } from './HelloDebug.types';

/**
 * HelloDebug Component
 * Displays 'Hello Debug Test' with the current timestamp.
 */
const HelloDebug: React.FC<HelloDebugProps> = ({ name = "Debug Test" }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      ...
      <p className="text-lg text-gray-600">Current Time: {timestamp}</p>
    </div>
  );
};
